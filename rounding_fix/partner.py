...
class res_partner(osv.osv):
    ...
    _columns = {
        ...
        'credit': fields.function(_credit_debit_get,
            fnct_search=_credit_search, string='Total Receivable', multi='dc', digits_compute=dp.get_precision('Account'), help="Total amount this customer owes you."),
        'debit': fields.function(_credit_debit_get, fnct_search=_debit_search, string='Total Payable', multi='dc', digits_compute=dp.get_precision('Account'), help="Total amount you have to pay to this supplier."),
        #'debit_limit': fields.float('Payable Limit'),
        'total_invoiced': fields.function(_invoice_total, string="Total Invoiced", type='float', digits_compute=dp.get_precision('Account'), groups='account.group_account_invoice'),
